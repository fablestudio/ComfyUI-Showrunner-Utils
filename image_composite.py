#copied from Allor Nodes https://github.com/Nourepide/ComfyUI-Allor
#Increased max container size to 4096

import torch
from PIL import Image as ImageF


class SR_ImageCompositeAbsolute:
    def __init__(self):
        pass
...
class SR_ImageCompositeAbsoluteByContainer:
    def __init__(self):
        pass
    ...
    def node(
        ...
        return SR_ImageCompositeAbsolute().node(
            images_a,
            images_b,
            images_a_x,
            images_a_y,
...
class SR_ImageCompositeRelative:
    def __init__(self):
        pass
...
class SR_ImageCompositeRelativeByContainer:
    def __init__(self):
        pass
